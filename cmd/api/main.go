...
func main() {
	...
	r := routes.SetupRoutes(authHandler, userHandler, topicHandler, lessonHandler, exerciseHandler, leaderboardHandler, questHandler, discussionHandler, levelHandler, badgeHandler)
